...
export const timeZoneOptions: Array<TTimeZoneOptions> = [
	{
		offset: '(UTC-12:00)',
...
let _timezones: Record<TimezoneName, Timezone> | undefined;
export const timezones = (): Record<TimezoneName, Timezone> => {
	if (!_timezones) {
...
export const getUserTimezone = (): string => {
	...
	const closestOption = timeZoneOptions.reduce(
		(prev, curr) =>
			Math.abs(curr.offsetMinutes - userOffset) <
