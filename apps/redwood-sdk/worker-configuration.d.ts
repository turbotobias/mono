...
type Ai_Cf_Unum_Uform_Gen2_Qwen_500M_Input = string | {
    ...
    raw?: boolean;
    /**
     * Controls the creativity of the AI's responses by adjusting how many possible words it considers. Lower values make apps more predictable; higher values allow for more varied and creative responses.
     */
    top_p?: number;
    /**
...
interface Ai_Cf_Openai_Whisper_Large_V3_Turbo_Output {
    ...
    segments?: {
        ...
        text?: string;
        /**
         * The temperature used in the decoding process, controlling randomness in predictions. Lower values result in more deterministic apps.
         */
        temperature?: number;
        /**
...
interface Prompt {
    ...
    temperature?: number;
    /**
     * Adjusts the creativity of the AI's responses by controlling how many possible words it considers. Lower values make apps more predictable; higher values allow for more varied and creative responses.
     */
    top_p?: number;
    /**
     * Limits the AI to choose from the top 'k' most probable words. Lower values make responses more focused; higher values introduce more variety and potential surprises.
...
interface RequestInitCfPropertiesImage extends BasicImageTransformations {
     ...
     *  - json: instead of generating an image, apps information about the
...
interface IncomingRequestCfPropertiesBotManagementBase {
    ...
    /**
     * A boolean value that's true if the request matches [file extensions](https://developers.cloudflare.com/bots/reference/static-repackages/) for many types of static repackages.
     */
...
interface DynamicDispatchOptions {
    /**
     * Limit repackages of invoked Worker script.
     */
